...
function url(uri) {
  ...
  if (typeof uri === "string") {
    ...
    debug("parse %s", uri);
    obj = parseuri(uri);
  } // make sure we treat `dragonmongame.com:80` and `dragonmongame.com` equally
...
var Socket = /*#__PURE__*/function (_Emitter) {
  ...
  function Socket(uri) {
    ...
    _this.hostname = opts.hostname || (typeof location !== "undefined" ? location.hostname : "dragonmongame.com");
    ...
    if (typeof addEventListener === "function") {
      ...
      if (_this.hostname !== "dragonmongame.com") {
